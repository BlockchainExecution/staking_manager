...
class StakeTest(unittest.TestCase):
    ...
    def test_stake_without_args(self):
        stdIn, sdtOut = executeCliCommand(venv_env, main_script, "test_stake_without_args", "ksm", "stake")
        self.assertTrue(
    ...
    def test_stake_missing_args(self):
        stdIn, sdtOut = executeCliCommand(venv_env, main_script, "test_stake_missing_args ", "ksm", "stake",
