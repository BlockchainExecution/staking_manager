...
class bonderTest(unittest.TestCase):
    ...
    def test_bond_without_args(self):
        stdIn, sdtOut = executeCliCommand(venv_env, main_script, "test_bond_without_args ", "ksm", "bonder", "bond")
        self.assertTrue(
    ...
    def test_bond_missing_args(self):
        stdIn, sdtOut = executeCliCommand(venv_env, main_script, "test_bond_missing_args ", "ksm", "bonder", "bond",
    ...
    def test_bond_size_failure(self):
        stdIn, sdtOut = executeCliCommand(venv_env, main_script, "test_bond_size_failure ", "ksm", "bonder", "bond",
    ...
    def test_bond_low_balance_failure(self):
        stdIn, sdtOut = executeCliCommand(venv_env, main_script, "test_bond_low_balance_failure ", "ksm", "bonder",
                                          "bond",
    ...
    def test_bond_decimal_point_failure(self):
        stdIn, sdtOut = executeCliCommand(venv_env, main_script, "test_bond_decimal_point_failure ", "ksm", "bonder",
                                          "bond",
    ...
    def test_bond_success(self):
        stdIn, sdtOut = executeCliCommand(venv_env, main_script, "test_bond_success ", "ksm", "bonder", "bond",
                                          "-m", mnemonic, "-ca", account, "-nt", "1")
        self.assertTrue(
            "sent and included in block" in stdIn)

    def test_bond_failure(self):
        stdIn, sdtOut = executeCliCommand(venv_env, main_script, "test_bond_failure", "ksm", "bonder", "bond",
                                          "-m", mnemonic, "-ca", account, "-nt", "1")
        self.assertTrue(
    ...
    def test_unbond_without_args(self):
        stdIn, sdtOut = executeCliCommand(venv_env, main_script, "test_unbond_without_args ", "ksm", "bonder",
                                          "unbond")
        self.assertTrue(
            "error: the following arguments are required: -m/--mnemonic, -nt/--number_of_tokens" in stdIn)

    def test_unbond_missing_args(self):
        stdIn, sdtOut = executeCliCommand(venv_env, main_script, "test_unbond_missing_args ", "ksm", "bonder",
                                          "unbond",
                                          "-m", mnemonic)
        self.assertTrue(
            "error: the following arguments are required: -nt/--number_of_tokens" in stdIn)
    ...
    def test_unbond_success(self):
        stdIn, sdtOut = executeCliCommand(venv_env, main_script, "test_unbond_success ", "ksm", "bonder", "unbond",
                                          "-m", mnemonic, "-nt", "1")
        self.assertTrue(
            "sent and included in block" in stdIn)
    ...
    def test_rebond_without_args(self):
        stdIn, sdtOut = executeCliCommand(venv_env, main_script, "test_rebond_without_args ", "ksm", "bonder",
                                          "rebond")
        self.assertTrue(
            "error: the following arguments are required: -m/--mnemonic, -nt/--number_of_tokens" in stdIn)

    def test_rebond_missing_args(self):
        stdIn, sdtOut = executeCliCommand(venv_env, main_script, "test_rebond_missing_args ", "ksm", "bonder",
                                          "rebond",
                                          "-m", mnemonic)
        self.assertTrue(
            "error: the following arguments are required: -nt/--number_of_tokens" in stdIn)
    ...
    def test_rebond(self):
        stdIn, sdtOut = executeCliCommand(venv_env, main_script, "test_rebond_success ", "ksm", "bonder", "rebond",
                                          "-m", mnemonic, "-nt", "1")
        self.assertTrue(
            "sent and included in block" in stdIn)
    ...
    def test_bondextra_without_args(self):
        stdIn, sdtOut = executeCliCommand(venv_env, main_script, "test_bondextra_without_args ", "ksm", "bonder",
                                          "bondextra")
        self.assertTrue(
            "error: the following arguments are required: -m/--mnemonic, -ca/--controller_address, -nt/--number_of_tokens" in stdIn)

    def test_bondextra_missing_args(self):
        stdIn, sdtOut = executeCliCommand(venv_env, main_script, "test_bondextra_missing_args ", "ksm", "bonder",
                                          "bondextra",
                                          "-m", mnemonic,"-ca",account)
        self.assertTrue(
            "error: the following arguments are required: -nt/--number_of_tokens" in stdIn)
    ...
    def test_bondextra_success(self):
        stdIn, sdtOut = executeCliCommand(venv_env, main_script, "test_bondextra_success", "ksm", "bonder",
    ...
    def test_withdrawunbonded_without_args(self):
        stdIn, sdtOut = executeCliCommand(venv_env, main_script, "test_withdrawunbonded_without_args ", "ksm",
    ...
    def test_withdrawunbonded_missing_args(self):
        stdIn, sdtOut = executeCliCommand(venv_env, main_script, "test_withdrawunbonded_missing_args ", "ksm",
                                          "bonder", "withdrawunbonded",
                                          "-m")
        self.assertTrue(
    ...
    def test_withdrawunbonded_success(self):
        stdIn, sdtOut = executeCliCommand(venv_env, main_script, "test_withdrawunbonded_success", "ksm", "bonder",
                                          "withdrawunbonded",
                                          "-m", mnemonic, "-nss", "1")
        self.assertTrue(
            "sent and included in block" in stdIn)
